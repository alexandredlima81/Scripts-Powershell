...
"@
    ...
    # Ação para redimensionar a partição C: após a remoção da partição de recuperação
    Write-Host "DEBUG: Obtendo o tamanho máximo suportado para a unidade C:..."
    $size = Get-PartitionSupportedSize -DriveLetter C

    Write-Host "DEBUG: Redimensionando a partição C: para o tamanho máximo..."
